jQuery(document).ready(function () {
    ...
    //         jQuery("#standard_number_of_subsites_dropdown").val("0");
    //         jQuery("#multisite_plus_no_of_instances_drop_down").val("1");
    //         jQuery("#multisite_plus_number_of_subsites_dropdown").val("0");
    //         jQuery("#pro_multiple_no_of_instances_drop_down").val("1");
    //         jQuery("#pro_multiple_number_of_subsites_dropdown").val("0");
