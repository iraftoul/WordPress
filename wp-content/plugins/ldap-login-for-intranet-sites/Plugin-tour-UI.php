...
<br><br><br>
    ...
    <div style="font-size: large; font-weight: 600;"><br><br>miniOrange LDAP/Active Directory Login for Intranet Sites
        <a id="license_upgrade" class="button button-large button-primary" style="position: relative; color:#fff; background-color:#f2881be0; border-color:#f2881be0" href="<?php echo add_query_arg( array( 'tab' => 'pricing' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>">Licensing Plans</a>
        <a id="ldap_troubleshooting_tab_pointer" style="position: relative" class="button button-large button-primary"  href="<?php echo add_query_arg( array('tab' => 'troubleshooting'), $_SERVER['REQUEST_URI'] ); ?>">FAQ's</a>
        <a id="ldap_account_setup_tab_pointer" style="position: relative" class="button button-large button-primary" href="<?php echo add_query_arg( array('tab' => 'account'), $_SERVER['REQUEST_URI'] ); ?>">Account Setup</a>
        <a id="ldap_trial_for_premium_plugin" style="position: relative;color:#fff;background-color:#f2881be0;border-color:#f2881be0" class="button button-large button-primary" href="<?php echo add_query_arg( array('tab' => 'trial_request'), $_SERVER['REQUEST_URI'] ); ?>">Request for Demo</a>
...
?>
    ...
    <div class="mo2f_container">
            <h2 class="nav-tab-wrapper">
                ...
                <a id="ldap_signin_settings_tab_pointer" style="position: relative" class="nav-tab" href="<?php echo add_query_arg( array('tab' => 'signin_settings'), $_SERVER['REQUEST_URI'] ); ?>">Sign- In Settings</a>
                <a id="ldap_multiple_directories_tab_pointer" style="position: relative" class="nav-tab" href="<?php echo add_query_arg( array('tab' => 'multiconfig'), $_SERVER['REQUEST_URI'] ); ?>">Multiple Directories</a>
                ...
                <a id="ldap_User_Report_tab_pointer" style="position: relative" class="nav-tab " href="<?php echo add_query_arg( array('tab' => 'Users_Report'), $_SERVER['REQUEST_URI'] ); ?>">Authentication Report</a>
            </h2>
