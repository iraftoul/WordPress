...
if (get_option('overall_plugin_tour') && get_option('overall_plugin_tour')=='true') {
    ...
    $pointers['miniorange-add-on-tab'] = array(
        ...
        <br><b>1. Sync Users LDAP Directory</b>
        <br><b>2. Auto Login (SSO) using Kerberos/NTLM</b>
        <br><b>3. Sync BuddyPress Extended Profiles</b>
        <br><b>4. Password Sync with LDAP Server</b>
...
else if(get_option('load_support_tab') && get_option('load_support_tab') =='true') {
